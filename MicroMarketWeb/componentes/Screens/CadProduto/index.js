    ...
    return (
        <View style={[style.container, Estilo.corPrimariaBackground]}>
            ...
            <View style={{alignItems: 'center', width: '100%'}}>
                <TouchableOpacity
                disabled={image === ''}
                style={[image === '' ?  {backgroundColor: '#e3e3e3'} : Estilo.corSecundariaBackground, {width: 350, height: 50, justifyContent: 'center', alignItems: 'center', borderRadius: 30}]} onPress={() => {cadastrarProduto(); console.log('x')}}>
